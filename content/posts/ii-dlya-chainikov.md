...
Получилась какая-то сеть: перечень нейронов, связей между ними и функций с весами. Теперь просто задаем вопрос и вычисляем ответ нейросети, никак не меняя веса - вот с этим и работаем.
