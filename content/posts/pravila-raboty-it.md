...
Указанные принципы и правила - не умозрительные построения, а правила работы реальной компании, рожденные и испытанные в реальных условиях.
При этом регулярно встречаю компании, где эти базовые правила не проросли, неизвестны, не соблюдаются.
...
Это система нанесения пользы (value) клиенту путем доставки ему ПО. В компании это выглядит так: от бизнеса система получает заказ на решение бизнес-задачи, исполняет этот заказ. Рядом в компании есть система взятия денег за нанесенную пользу (продажи), система поиска клиентов (маркетинг) и т.д.
...
Производство можно представить как помещение, цех. Внутри чумазые рабочие по уши в масле клепают молотками, сверлят, пилят очередную штуковину. Как оно внутри устроено - как ремесло, мануфактура или конвейер - зависит от целей, масштаба, способностей руководителя.
...
-   компании выгоден "отпуск по пятницам", отправлять сотрудников в отпуск на 1-2 дня. И многим сотрудникам это удобно. А любимый Трудовой кодекс заставляет отправлять в отпуск на 14 дней. Значит нужно найти административное решение, обходящее ТК на пользу производственной необходимости.
...
5.  Важен фокус внимания: концентрация на ключевых проблемах,  делегирование или откладывание неключевых. Поиск и выявление ключевых проблем - сложная задача.
6.  Важен ритм: выделить цель и постоянно идти к ней, не останавливаясь.
...
7.  Персональная отвественность за результат.
...
8.  Продуктивная деятельность требует времени и концентрации, разумные решения рациональны. Порядки в компании должны поощрять и поддерживать осмысленную работу.
9.  Сюрпризы - плохо.
...
1.  Должна быть выстроена оргструктура и зоны ответственности.
    Нужно исключить микроменеджмент, без четких зон ответственности каждая задача обсуждается по 10 раз разными сотрудниками в разной конфигурации.
...
2.  Нужно понимать и управлять тем что компания дает сотруднику и что сотрудник дает компании.
    ...
    -   Налаживание отношений компании с сотрудниками - совместная задача руководства и HR.
        -   Для понимания отношения сотрудников к компании нужно регулярно измерять ENPS.
...
3.  Все хотят работать удаленно, но не все могут. IT-компания скорее всего работает на удаленке или гибриде.
    ...
    -   Процессы в компании и инструменты должны быть адаптированы под удаленную работу.
        Например, дни встреч в офисе для гибридных сотрудников, информирование об отпусках и графиках работы, назначение встреч через онлайн и т.д.
        Понятно что сотрудник на удаленке не может пройтись по офису и поговорить с коллегой, пересечься у кулера и т.д. Надо дать ему возможность замены этого общения.
...
Руководитель подключается к проблеме если у ответственного не получается найти решение и предварительное обсуждение уже проведено.
...
Итак, у компании есть чат, таск-трекер, вики, почта, видеосвязь.
...
Есть 2 публичных календаря компании: "отпуска-отгулы"(человека нет на рабочем месте, не работает) и "удаленная работа"(где он? в офисе или дома).
...
Индикация прочтения сообщений пользователями не нужна. Время изменения сообщений должно быть ограничено, например 3 минуты.
Исходя из этих требований видно, что Telegram не подходит как рабочий чат.
...
7.  У всех пользователей в аккаунтах в чате должны быть аватар, должность, почта, реальные имя и фамилия.
...
6.  Остальные правила движения тикетов, поля тикетов, типы, статусы, правила оформления внутри каждого направления определяет руководитель направления.
...
Ведение задач в тикетах приводит к:

-   простота подключения к любой проблеме
-   проверяемая история любой проблемы
-   обзор результатов работы за день, неделю, месяц по любому сотруднику, подразделению, по теме
-   статистика по задачам, нагрузке, качеству решения задач


#### Видеовстречи {#видеовстречи}

1.  У каждого совещания должна быть онлайн встреча, доступная все участникам.
...
-   Единая учетная запись в компании,
-   сюда приходят расчетные листки
-   и странные письма от странных людей, не участвующих в производстве.
...
3.  Материалы для встречи (повестка, ссылки на тикеты, документы, резюме) нужно прикладывать ко встрече в календаре.
...
14. У встречи заполнено место встречи - оффлайн и онлайн.
...
1.  Регламент это описание процесса, записанное в wiki. (Объявления в чате - не регламент, хотя могут о нем напоминать, указывать на него, информировать о вводе регламента.) У каждого процесса должен быть ответственный владелец, указан в wiki, он ведет страничку wiki, без его подтверждения менять регламент нельзя.
...
4.  Для ввода регламента в работу должна быть ссылка на него с главной странички wiki и объявление в чате от отв. за регламент, предварительно согласованное с ГД.
...
Яндекс360
: почта, видео, календарь

Redmine
: таск-трекер, вики

Казалось бы, правила просты, очевидны, удобны. Однако люди годами живут без них и не знают что можно жить по-другому.
