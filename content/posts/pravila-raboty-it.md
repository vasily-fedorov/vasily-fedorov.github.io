...
5.  Встречи с внешними пользователями (клиентами, бизнесом)  можно записывать с их согласия. Встречи с внешними пользователями надо стараться записывать.
...
Опубликовал [тут](https://habr.com/ru/articles/881392/) .
