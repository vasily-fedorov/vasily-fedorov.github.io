...
Кандидаты на роль РП, которые могут оказаться неподходящими:
...
Крайне важно определить ключевые результаты проекта и сосредоточиться на их достижении. Смотреть надо на цель, а не под ноги.
...
Несмотря на значимость планирования, РП порой уклоняются от его составления, что является нормальным явлением. Процесс требует определённых компетенций, опыта, информации от заказчика и смелости в формулировании предположений, которые могут быть подвергнуты критике.
...
Регулярное обновление плана является обязательным, как для контроля за соблюдением сроков, так и для учета изменяющейся ситуации в проекте.
Следует пересматривать план проекта примерно раз в месяц с акцентом на задачи, сроки и ресурсы.
...
Более того, успешно сданный исполнителем проект может оказаться провалом для заказчика: по результатам проекта за рамками проекта должны пройти изменения процессов, оргструктуры, подходов в заказчике. Эту работу часто недооценивают.
...
При этом прямое управление заказчиком невозможно, но существуют непрямые способы управления:
...
2.  Необходимо разместить в доступном для заказчика месте (общий канал, общее письмо), обеспечив доступ к кураторов со стороны исполнителя и заказчика.
3.  Должен содержать актуальные вопросы к заказчику с указанием дат и ссылками на историю ("нужно то-то и то-то, запрашиваем в третий раз, первый был месяц назад").
4.  Должен отражать полную текущую ситуацию по проекту: что было сделано за неделю, что планируется, какие вопросы и проблемы актуальны. Вся картина отражена в статусе, дополнительных активностей нет.
5.  Статус по проекту следует использовать в обсуждениях, чтобы заказчик понимал, что это основа для работы.
...
Грамотный заказчик заинтересован в фиксации задач, комментариев и эффективности работы с ними, что позволяет ускорить процесс и фиксировать договоренности с помощью трекера. Тикеты ведутся в отдельном проекте "для заказчика", внутренние процессы остаются обособленными.
...
1.  Руководитель проекта (РП), ответственный перед заказчиком за выполнение всего проекта.
2.  Архитектор, ответственный за интеграцию проекта в инфраструктуру заказчика и за применение единых подходов к решению аналогичных задач и технологий на проекте.
3.  Ведущий бизнес-аналитик, отвечающий за анализ проблем, стоящих перед заказчиком в рамках проекта.
4.  Ведущий системный аналитик, ответственный за настройку ПО и реализацию задач по его доработке.
5.  Менеджер, который будет отвечать за коммуникацию с разработчиками и внедренцами.
6.  Ведущий разработчик/тимлид, отвечающий за процессы разработки в проекте.
7.  Менеджер по организационным вопросам, ответственный за координацию команды (подключение участников, проведение встреч, ведение протоколов).
8.  Тестировщик, который будет ответственен за обеспечение качества работы разработчиков и корректности настроек системы.
9.  DevOps-специалист, отвечающий за работу внутренних стендов в процессе разработки и за запуск итогового продукта на стороне заказчика.
10. Куратор проекта, который контролирует качество выполнения работ и обеспечивает эскалацию проблем для заказчика.
11. Администратор проекта, ответственный за правильное оформление документации.
12. Необходимое число аналитиков, разработчиков, тестировщиков, и DevOps-специалистов для выполнения задач проекта.
...
1.  Нельзя придумывать дедлайны.
    РП не должен самостоятельно устанавливать необоснованные сроки, обманывая команду, так как это может привести к недоверию, а потом и саботажу со стороны исполнителей.
...
2.  Неэффективный РП и эффективная команда:
    Команда справляется с трудностями, несмотря на недостаточную поддержку. Проблемы в проекте накапливаются, а информация о них не выходит изкомандв, что повышает риски провала проекта.
